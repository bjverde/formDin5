...
class exe_TButton extends TPage
{
    ...
    public function __construct()
    {
        ...
        $alert = $frm->addButton('Alert JS','alertjs','onSave1','alert("Hello! I am an alert box!!");',null,true,false,'far:check-circle green');
        $alert->setPopover('Mensagem JS','top','Informe o nome de uma função JS ou coloque toda função JS que será executada no onClick. ');
