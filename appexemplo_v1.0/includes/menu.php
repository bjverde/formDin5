...
$menu->add('11', '1', 'Campo Texto', null, 'Declaração de texto');
	$menu->add('11.1', '11', 'Campo Texto Simples');
    	$menu->add('11.1.1', '11.1', 'Campo Texto', 'view/fields/exe_TextField.php');
    	$menu->add('11.1.2', '11.1', 'Entrada com Máscara', 'view/fields/exe_maskField.php')->setJsonParams("{'p1':'parametro_1','p2':'parametro_2'}");
