...
REM ECHO PHP 8.1.0 and PHPUnit 9.5.9 Simples with Coverage
c:\wamp64\bin\php\php8.1.0\php.exe c:\wamp64\bin\phpunit\phpunit-9.5.9.phar --colors=auto --bootstrap C:\wamp64\www\adinatiApp\formDin5\appexemplo_v1.0\init.php --whitelist C:\wamp64\www\adinatiApp\formDin5\appexemplo_v1.0\app\lib\widget\FormDin5 --coverage-html C:\wamp64\www\adinatiApp\formDin5\phpunit-code-coverage\html C:\wamp64\www\adinatiApp\formDin5\appexemplo_v1.0\app\tests\

REM ECHO php 8.1.0 and PHPUnit 9.5.9 with Config XML file
REM d:\wamp64\bin\php\php8.1.0\php.exe  d:\wamp64\bin\phpunit\phpunit-9.5.9.phar --configuration D:\wamp64\www\adianti\formDin5\appexemplo_v1.0\app\tests\phpunit-conf-win.xml
