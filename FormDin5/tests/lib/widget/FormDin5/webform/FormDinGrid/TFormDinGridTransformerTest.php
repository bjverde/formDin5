...
class TFormDinGridTransformerTest extends TestCase
{
    ...
    public function testDateAndGridDate()
    {
        ...
        $this->assertEquals('invalid-date', TFormDinGridTransformer::date('invalid-date'));
    ...
    public function testGridImg()
    {
        ...
        // Test with actual file path to trigger the is_file == true branch
        $actualFile = basename(__FILE__);
        $imgPath = dirname(__FILE__) . '/';
        $resultActualFile = TFormDinGridTransformer::gridImg($actualFile, $obj, $row, $imgPath, '100px', null);
        $this->assertInstanceOf(TImage::class, $resultActualFile);
    }
    ...
    public function testDateTimeAndGridDateTime()
    {
        ...
        $this->assertEquals('invalid-datetime', TFormDinGridTransformer::dateTime('invalid-datetime'));
    ...
    public function testGridNumeroBrasilAndFormatStyle()
    {
        ...
        $nullStyle = TFormDinGridTransformer::gridNumeroBrasilFormatStyle(null, $obj, $row);
        $this->assertStringContainsString('color:red', $nullStyle);
        $this->assertStringContainsString('0,00', $nullStyle);
    }
