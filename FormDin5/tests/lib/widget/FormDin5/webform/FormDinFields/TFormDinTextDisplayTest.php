...
class TFormDinTextDisplayTest extends TestCase
{
    ...
    public function test_cnpjCpf()
    {
        ...
        $this->assertEquals('123.456.789-09', $displayCpf->getAdiantiObj()->getChildren()[0]);

        // Test CNPJ formatting
        $displayCnpj = TFormDinTextDisplay::cnpjCpf('cnpj_id', 'CNPJ Label', '12345678000199');
        $this->assertEquals('12.345.678/0001-99', $displayCnpj->getAdiantiObj()->getChildren()[0]);
    }
    ...
    public function test_phoneNumber()
    {
        ...
        $this->assertEquals('(61) 98888-7777', $displayPhone->getAdiantiObj()->getChildren()[0]);
    }
    ...
    public function test_dataTimeBr()
    {
        ...
        $this->assertEquals('26/05/2026', $displayDate->getAdiantiObj()->getChildren()[0]);

        $displayDateTime = TFormDinTextDisplay::dataTimeBr('datetime_id', 'DateTime Label', '2026-05-26 14:30:15', true, true);
        $this->assertEquals('26/05/2026 14:30:15', $displayDateTime->getAdiantiObj()->getChildren()[0]);
    }
    ...
    public function test_numeroBrasil()
    {
        ...
        $this->assertEquals('1.234.567,89', $displayNum->getAdiantiObj()->getChildren()[0]);
    }
}
